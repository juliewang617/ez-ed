    ...
    return(
        <div>
            ...
            <div className="page-heading-section">
                ...
                <p className="page-caption">Upload an image below and have our AI 
                    tool classify it as one of several common skin conditions. 
                </p>
            </div>
            <div className="page-body-no-flex">
                ...
                {predictions.length !== 0 && 
                    <div className="predictions-container">
                        ...
                        <h2>
                            {labels[predictions.indexOf(Math.max(...predictions))]}
                        </h2>
                ...
                <div className="model-info">
                    ...
                    datasets:  
                    <Link href="https://www.kaggle.com/datasets/riyaelizashaju/skin-disease-classification-image-dataset">Skin Disease Classification Image Dataset</Link>,
                    <Link href="https://www.kaggle.com/datasets/nayanchaure/acne-dataset">Acne Dataset</Link>,
                    and <Link href="https://www.kaggle.com/datasets/shakyadissanayake/oily-dry-and-normal-skin-types-dataset/data">Oily Dry, and Normal Skin Types Dataset</Link>.
                    </p>
