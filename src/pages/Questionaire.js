...
export default function Questionaire(){
    ...
    const nextQuestion = () => {
        ...
        if (index >= questions.length - 1) {
            ...
            var retake_button = document.getElementsByClassName("questionaire-retake-btn")[0]; 
            var container = document.getElementsByClassName("radio-container")[0];
            var results = document.getElementsByClassName("results")[0];
            var score_meaning = document.getElementsByClassName("score-meaning-container")[0];
            ...
            if(score <= 2){
                results.innerHTML = "With a score of " + String(score) + ", You or your child likely has clear to almost clear eczema symptoms.";
            } else if (3 <= score <= 7){
                results.innerHTML = "With a score of " + String(score) + ", You or your child likely has signs of mild eczema.";
            } else if (8 <= score <= 16){
                results.innerHTML = "With a score of " + String(score) + ", You or your child likely has signs of moderate eczema.";
            } else if (17 <= score <= 24){
                results.innerHTML = "With a score of " + String(score) + ", You or your child likely has signs of severe eczema.";
            } else if (25 <= score <= 28){
                results.innerHTML = "With a score of " + String(score) + ", You or your child likely has signs of very severe eczema.";
            }
    ...
    return(
        <div>
            ...
            <form className="page-body-flex">
                ...
                <button type="button" className="questionaire-next-btn" onClick={nextQuestion}>Next</button>

                <button type="button" className="questionaire-retake-btn" 
                onClick={() => window.location="/questionaire"}> Retake</button>
