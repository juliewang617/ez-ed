...
/**
 * @returns {ReactNode} A React Element that renders the WhatYouCanDo page.
 */
    ...
    <div>
      ...
      <div className="page-heading-section">
        ...
        <p className="page-caption">
          See how you can help fight health inequity regarding atopic
          dermatitis.
        </p>
      </div>
      ...
      <div className="page-body-no-flex">
        ...
        <p>
          ...
          worldwide, but its impact is not uniform. Significant disparities
          exist based on race, socioeconomic status, mental health, and more.
          For instance, Black, Latino, and Asian individuals are more likely to
          develop severe forms of eczema in the US and also face greater
          challenges in managing it, often due to systemic challenges. Moreover,
          low-income individuals often face barriers to accessing adequate
          healthcare and live in conditions that may aggravate their condition.
        </p>
        <p>
          By working towards health equity, we can ensure that everyone has
          access to the care and resources they need to effectively manage their
          condition, regardless of their identity or background. By addressing
          the factors, which are often systemic, contributing to these
          disparities, we can improve the quality of life for millions of people
          worldwide.
        </p>

        <img
          src={handsOnTreeImg}
          alt="multiple hands on a tree"
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              <a href="https://www.niaid.nih.gov/diseases-conditions/eczema-treatment">
        ...
        <blockquote>
          ...
          <a href="https://nationaleczema.org/research/clinical-trials/">
        ...
        <ul>
          <li>
            <b>
              <a href="https://nationaleczema.org/support-the-nea-research-fund/">
                The NEA Research Fund:
              </a>
            </b>{" "}
            created by the National Eczema Association, the NEA Research Fund is
            the largest private funder of eczema research in the United States.
          </li>
          <li>
            <b>
              <a href="https://eczema.org/donate/">
                The National Eczema Society
              </a>
            </b>{" "}
            is a London-based charity dedicated to improving outcomes for people
            with eczema by spreading awareness and funding research.
          </li>
          <li>
            <b>
              <a href="https://www.gper.org/giving">GPER</a>
            </b>{" "}
            (Global Parents for Eczema Research) is the only global non-profit
            dedicated to supporting children with eczema.
          </li>
        </ul>
        ...
        <p>
          Cochran, Raechele, and Bukky Aremu. “The Importance of Diversity in
          Eczema Clinical Trials.” <i>MedicalNewsToday</i>, 17 February 2023,
          https://www.medicalnewstoday.com/articles/diversity-eczema-clinical-trials#why-it-matters.
        </p>

        <p>
          Chen V, Akhtar S, Zheng C, Kumaresan V, Nouri K. Assessment of Changes
          in Diversity in Dermatology Clinical Trials Between 2010-2015 and
          2015-2020: A Systematic Review.
          <i>JAMA Dermatol. </i> 2022;158(3):288–292.
