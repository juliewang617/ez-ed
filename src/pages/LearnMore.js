...
/**
 * @returns {ReactNode} A React Element that renders the LearnMore page.
 */
    ...
    <div>
      ...
      <div className="page-heading-section">
        ...
        <p className="page-caption">
          Learn more about atopic dermatitis - its symptoms, impacts, and health
          inequities.
        </p>
      </div>
      <div className="page-body-no-flex">
        <div>
          ...
          <p>
            ...
            characterized by inflammation, redness, and irritation. Symptoms can
            appear anywhere on the body and vary widely but often include dry
            skin, itchiness, rashes, and oozing. Inflamed skin can look red on
            white skin, and darker brown, purple, or gray on brown and black
            skin.
          </p>
          <p>
            <blockquote>
              171 million individuals worldwide were affected by eczema in 2019.
            </blockquote>
            While the cause of atopic dermatitis is uncertain, it appears to run
            in families. Environmental causes, such as living in often cold or
            polluted areas, may also be a factor. Atopic dermatitis is not
            contagious.
          </p>
          <p>
            There are many types of eczema, each with its own symptoms and
            treatments. While this site focuses on the most common form, atopic
            dermatitis, many other forms of eczema exist as well.{" "}
            <a href="https://www.yalemedicine.org/conditions/eczema">
              Read here
            </a>{" "}
        ...
        <div>
          ...
          <p>
            Low-income individuals, such as refugees or migrants, are documented
            to live in low-quality housing within refugee camps or immigrant
            communities. Such dwellings have been documented to have excess
        ...
        <ul>
          <li>
            ...
            doctor appointments, delaying or missing treatment.
          </li>
          <li>
            <b>Income: </b> low-income individuals may avoid treatment to save
            money or live in areas without specialized care options.
          </li>
          <li>
          ...
          <li>
            <b>Education Inequality:</b> People without an understanding of
            eczema may use incorrect medications/treatments or not follow
        ...
        <div>
          ...
          <p>
            ...
            regardless of their socio-economic status, race, or environment,
            have access to effective care for their condition.
          </p>
          <p>
            By focusing on health equity, especially through the lens of skin
            conditions like atopic dermatitis, we can work towards a more equal
            and widespread healthcare system.
          </p>

          <blockquote>
            Want to help? <a href="/whatyoucando">Click here.</a>
          </blockquote>
          ...
          <p>
            Smith, Wendy, and Jodi L. Johnson. “Mental Health and Eczema –
            Seeing the Unseen.” <i>National Eczema Association</i>, 3 May 2021,
          ...
          <p>
            ...
            , vol. 38, no. 5, 2024, pp. 801-811,
            https://doi.org/10.1111/jdv.19723. Accessed 25 Jul. 2024.
          </p>

          <p>
            Jelousi, Sami, et al. "The Impact of Global Health Disparities on
            Atopic Dermatitis in Displaced Populations: Narrowing the Health
            Equity Gap for Patients with Skin of Color."
            <i>Dermatology and Therapy</i>, vol. 12, no. 12, 2022, pp.
            2679-2689,
          </p>
        </div>
      </div>
