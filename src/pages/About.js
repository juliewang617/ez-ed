...
/**
 * @returns {ReactNode} A React Element that renders the About page.
 */
  ...
  return (
    <div>
      ...
      <div className="page-body-no-flex">
        <p>
          As someone who has experienced atopic and seborrheic dermatitis my
          whole life, I owe a lot to my dermatologist and family for providing
          the best possible care for me to manage my condition to a stable
          point.
        </p>
        ...
        <p>
          <b>Ezcema-Educate</b> (Ez-Ed) aims to spread awareness on the impact
          of eczema and the widespread disparities in access to care. Moreover,
          for those with atopic dermatitis, Ez-Ed offers guidance in managing
          and identifying symptoms to lessen eczema’s impact on their lives.
        </p>
